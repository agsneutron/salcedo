...
class Employee(models.Model):
    ...
    phone_number = models.IntegerField(verbose_name="Teléfono*", max_length=20, null=False, blank=False)
    cellphone_number = models.IntegerField(verbose_name="Celular", max_length=20, null=False, blank=True)
    office_number = models.IntegerField(verbose_name="Teléfono de Oficina", max_length=20, null=False, blank=True)
    extension_number = models.IntegerField(verbose_name="Número de Extensión", max_length=10, null=False, blank=True)
    personal_email = models.CharField(verbose_name="Correo Electrónico Personal*", max_length=255, null=True,
                                      blank=False)
    work_email = models.CharField(verbose_name="Correo Electrónico Laboral", max_length=255, null=False, blank=True)
    ...
    zip_code = models.IntegerField(verbose_name="Código Postal*", max_length=5, null=False, blank=False)
...
class FamilyMember(models.Model):
    ...
    phone_number = models.IntegerField(verbose_name="Número de Teléfono", max_length=20, null=True, blank=True)
...
class EmergencyContact(models.Model):
    ...
    second_last_name = models.CharField(verbose_name="Apellido Materno*", max_length=255, null=False, blank=False)
    phone_number = models.IntegerField(verbose_name="Número de Teléfono", max_length=20, null=True, blank=True)
    cellphone_number = models.IntegerField(verbose_name="Número de Celular", max_length=20, null=True, blank=True)
